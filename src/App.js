...
const YOUR_EMAIL     = "guy@guyweaver.com";
...
const questions = [
  {
    ...
    options: [
      { text: "A smarter search engine — I ask it questions and it gives me answers", score: 0.5 },
  ...
  },
  {
    ...
    options: [
      { text: "I always use the same tool — whatever I opened first", score: 0.5 },
  ...
  },
  {
    ...
    options: [
      { text: "A short question or instruction — I keep it simple", score: 0.5 },
  ...
  },
  {
    ...
    options: [
      { text: "I re-explain my role and context at the start of most conversations", score: 0.5 },
  ...
  },
  {
    ...
    options: [
      { text: "I haven't noticed this happening", score: 0.5 },
  ...
  },
  {
    ...
    options: [
      { text: "I write one prompt asking for everything at once", score: 0.5 },
  ...
  },
  {
    ...
    options: [
      { text: "I write what comes to mind and run it — if it's wrong I correct it afterwards", score: 0.5 },
  ...
  },
  {
    ...
    options: [
      { text: "I use one tool for everything — whichever my organisation provided", score: 0.5 },
  ...
  },
  {
    ...
    options: [
      { text: "I paste the full text directly into the chat", score: 0.5 },
  ...
  },
  {
    ...
    options: [
      { text: "I generally trust the output — it usually looks right", score: 0.5 },
  ...
  },
  {
    ...
    options: [
      { text: "I use AI through chat interfaces only — I didn't know automation was possible", score: 0.5 },
  ...
  },
  {
    ...
    options: [
      { text: "I'm not sure what our policy is — I use my judgement", score: 0.5 },
...
export default function App() {
  ...
  const submitResults = async (finalAnswers) => {
    ...
    const emailBody = {
      ...
      subject: `AI Diagnostic — ${name || "Anonymous"} · ${level} (${Math.round((totalScore / maxScore) * 100)}%)`,
    ...
    // Zapier webhook — sends to Google Sheets
    const zapierParams = new URLSearchParams({
      date: new Date().toLocaleDateString("en-GB"),
      name: name || "Anonymous",
      total_score: `${Math.round((totalScore / maxScore) * 100)}%`,
      level,
      q1_mindset: finalAnswers.ai_mindset || "",
      q2_model_selection: finalAnswers.model_selection || "",
      q3_prompt_quality: finalAnswers.prompt_structure || "",
      q4_context_memory: finalAnswers.context_files || "",
      q5_context_drift: finalAnswers.context_drift || "",
      q6_task_architecture: finalAnswers.task_architecture || "",
      q7_prompt_optimisation: finalAnswers.reverse_prompting || "",
      q8_tool_strategy: finalAnswers.multi_tool || "",
      q9_document_handling: finalAnswers.document_handling || "",
      q10_verification: finalAnswers.verification || "",
      q11_agents_automation: finalAnswers.agents_automation || "",
      q12_data_security: finalAnswers.data_security || "",
    });
    ...
    try {
      await Promise.all([
        ...
        fetch(`${ZAPIER_WEBHOOK}?${zapierParams.toString()}`, {
          method: "GET",
          mode: "no-cors",
        }),
      ]);
        ...
        {phase === "results" && (
          <div className="fade-in">
            ...
            <div style={{
              ...
              <a
                href="https://www.guyweaver.com/ai-training"
                target="_blank"
              ...
              >
                Learn more at guyweaver.com/ai-training →
              </a>
            </div>
